...
<head>
    ...
    <link href="resources/mem_css/bootstrap.min.css" rel="stylesheet">
    <link href="resources/mem_css/templatemo-xtra-blog.css" rel="stylesheet">
    <link href="resources/mem_css/kkj.css" rel="stylesheet">
</head>
<body>
        ...
        <main class="tm-main">
            ...
            <div class="row tm-row">
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <p class="tm-pt-30">
                        관리자 페이지에서 작성한 내용 여기에 표시<br>
                        안녕반가워
                    </p>
                    <hr>
                    <div class="d-flex justify-content-between tm-pt-45">
                        <span class="tm-color-primary">2022.11.21</span><!--2022.11.21-->
                        <span>댓글 36</span><!--댓글 36-->
                    </div>
                </article>
                <article class="col-12 col-md-6 tm-post">
                    <hr class="tm-hr-primary">
                    ...
                    <p class="tm-pt-30">
                        관리자 페이지에서 작성한 내용 여기에 표시
                    </p>
                    <hr>
                    <div class="d-flex justify-content-between tm-pt-45">
                        <span class="tm-color-primary">여기에 날짜 표시</span><!--2022.11.21-->
                        <span>댓글 수 표시</span><!--댓글 36-->
                    </div>
                </article>
                <article class="col-12 col-md-6 tm-post">
                    <hr class="tm-hr-primary">
            ...
            <div class="row tm-row tm-mt-100 tm-mb-75 text-center">
                <div class="tm-paging">
                    <nav class="tm-paging-nav d-inline-block">
                        <ul>
                            <li class="tm-paging-link">
                                <a href="#" class="mb-2 tm-btn tm-btn-primary disabled tm-mr-20"><<</a>
                            </li>
                            ...
                            <li class="tm-paging-link">
                                <a href="#" class="mb-2 tm-btn tm-btn-primary tm-mr-20">>></a>
                            </li>
                        </ul>
                    </nav>
                </div>               
...
<script src="/resources/mem_js/jquery.min.js"></script>
<script src="/resources/mem_js/templatemo-script.js"></script>
</body>
</html>